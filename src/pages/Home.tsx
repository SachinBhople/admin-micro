...
const Home: React.FC = () => {
    ...
    return <>
        <div className="flex h-screen bg-gray-100">
            ...
            <div className="w-64 bg-teal-600 text-white flex flex-col p-4">
            ...
            <div className="flex-1 bg-gray-50 p-6">
                ...
                <header className="flex items-center justify-between border-b-2 border-gray-200 pb-4 mb-6">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button onClick={logout} className="bg-teal-600 text-white px-4 py-2 rounded-lg hover:bg-teal-500 transition">Logout</button>
                    </div>
                </header>
